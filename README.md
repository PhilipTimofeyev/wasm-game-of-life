...
This is a project that uses Rust compiled to WebAssembly to create the backend of John Conway's Game of Life, and interfaces with HTML, CSS and Javascript to draw a graph of cells that can be represented in either a live or dead state, and evolve based on a cell's neighbors.
